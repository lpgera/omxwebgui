...
mkfifo $3
omxplayer -o hdmi --audio_queue 32 --video_queue 128 --font /usr/share/fonts/truetype/dejavu/DejaVuSans.ttf --italic-font /usr/share/fonts/truetype/dejavu/DejaVuSans.ttf -b "$1" < $3 &
echo -n "." > $3 &
